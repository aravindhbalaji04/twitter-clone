...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased bg-[#F7F9F9] text-black dark:bg-black dark:text-white min-h-screen`}>
        <ThemeProvider>
          <AuthProvider>
            <div className="flex min-h-screen w-full">
              {/* Sidebar */}
              <aside className="hidden md:flex flex-col w-64 px-4 py-8 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-[#16181C] gap-2 sticky top-0 h-screen">
                <div className="mb-8 flex flex-col items-center gap-2 justify-center">
              ...
              {/* Main Feed */}
              <main className="flex-1 flex flex-col items-center min-h-screen bg-white dark:bg-black text-black dark:text-white px-2 md:px-0 relative">
              ...
              {/* Rightbar */}
              <aside className="hidden lg:flex flex-col w-80 px-4 py-8 border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-[#16181C] gap-6 sticky top-0 h-screen">
